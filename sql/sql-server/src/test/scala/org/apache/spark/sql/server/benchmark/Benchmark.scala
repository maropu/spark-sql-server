...
package org.apache.spark.sql.server.benchmark
 ...
 */
private[benchmark] class Benchmark(
    name: String,
...
private[benchmark] object Benchmark {
  ...
  def getProcessorName(): String = {
    ...
    val cpu = if (osName.contains("Mac")) {
