...
private class LivyOperation(
    ...
    _statementId: String)
  extends OperationImpl(sessionState, query)(_statementId) {
...
private[livy] class LivyExecutorImpl() extends OperationExecutor {
  ...
  override def newOperation(
    ...
    new LivyOperation(sessionState, query)(statementId)
  }
}
